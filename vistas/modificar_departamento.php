...
<div class="content" style="background-color: #ADD8E6;">
    <div class="container mt-0">
        ...
        <form method="POST" action="../controlador/controlador_departamento.php" id="departamentoForm" onsubmit="return validarFormulario(event)">

            <!-- BUTTON DEL MODAL DEPARTAMENTO -->
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#Modal_departamento">
                Tabla de Departamento
            </button>

            <!-- MODAL DE DEPARTAMENTO -->
            <div class="modal fade" id="Modal_departamento" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="input-group input-group-sm mb-3 w-75">
                                ...
                                <input type="text" class="form-control" id="c_codigo_buscar_departamento" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="INGRESAR CODIGO DE DEPARTAMENTO">
                            </div>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div id="tabla_departamento"></div>
                        </div>
...
<!-- BOTOON DEL MODAL DE TURNO -->
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalturno">
                Tabla de Turno
            </button>
            ...
            <div class="row gx-5">
                <div class="col ml-2">
                    ...
                    <div class="form-group mr-1 w-75">
                        ...
                        <input type="text" class="form-control input-readonly" name="c_codigo_depa" maxlength="10" pattern="\w{1,10}" readonly required>
                    </div>
...
<script src="../js/funciones_departamentos.js"></script>
